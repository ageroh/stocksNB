                ...
                success: function (r) {
                    if (r) {
                        ...
                        $(".scrolled .name a").on("click", function (ev) {
                            ...
                            document.location.href = '/StocksPageN.aspx?stock=' + $(this).text(); //relative to domain
                            //document.location.url = 'http://www.news.gr/stockdetails?symbol=' + $(this).text(); //relative to domain
